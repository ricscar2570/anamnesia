...
Regole base, 4 Archetipi, scenario L'Incidente, sistema Frammenti e Dadi.

---

## E Poi?

AnamnesiA è un progetto vivo. Le prossime direzioni possibili:

**Espansione: Echi dall'Abisso** — Modulo cosmic horror con nuovi Archetipi (Il Prescelto, Il Varco, L'Eco, Il Custode, Il Sacrificato), Entità Cosmiche, Frammenti Impossibili e nuove meccaniche (Frattura, Velo della Realtà).

**Nuovi Scenari** — L'Esperimento (laboratorio universitario, etica della ricerca), scenari creati dalla community.

**Carte Frammento Generiche** — Un mazzo di 36 carte universali (12 per fase) usabili con qualsiasi scenario, inclusi quelli creati dai giocatori.

**Kickstarter** — Edizione fisica con carte in cartoncino, schede a colori, e manuale illustrato.
